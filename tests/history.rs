use krill::upgrades::v0_9_0::CaObjectsMigration;
...
/// here.
///
/// NOTE: If you are sure that the representation of history and historical commands
///       can be changed, then you can get this test to regenerate the expected new content
///       by deleting the 'expected' directories under 'test-resources/api/regressions/v0_6_0/history',
///       and setting the env variable: KRILL_HISTORY_JSON_GENERATE
#[tokio::test]
async fn history() {
