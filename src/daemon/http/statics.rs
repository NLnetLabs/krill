...
pub async fn statics(req: Request) -> RoutingResult {
    match *req.method() {
        Method::GET => match req.path.full() {
            ...
            "/fonts/source-code-pro-latin-200.woff" => {
                Ok(HttpResponse::woff(FONTS_SOURCE_CODE_200))
            }
            "/fonts/source-code-pro-latin-200.woff2" => {
                Ok(HttpResponse::woff2(FONTS_SOURCE_CODE_200_2))
            }
            "/fonts/source-code-pro-latin-300.woff" => {
                Ok(HttpResponse::woff(FONTS_SOURCE_CODE_300))
            }
            "/fonts/source-code-pro-latin-300.woff2" => {
                Ok(HttpResponse::woff2(FONTS_SOURCE_CODE_300_2))
            }
            "/fonts/source-code-pro-latin-400.woff" => {
                Ok(HttpResponse::woff(FONTS_SOURCE_CODE_400))
            }
            "/fonts/source-code-pro-latin-400.woff2" => {
                Ok(HttpResponse::woff2(FONTS_SOURCE_CODE_400_2))
            }
            "/fonts/source-code-pro-latin-500.woff" => {
                Ok(HttpResponse::woff(FONTS_SOURCE_CODE_500))
            }
            "/fonts/source-code-pro-latin-500.woff2" => {
                Ok(HttpResponse::woff2(FONTS_SOURCE_CODE_500_2))
            }
            "/fonts/source-code-pro-latin-600.woff" => {
                Ok(HttpResponse::woff(FONTS_SOURCE_CODE_600))
            }
            "/fonts/source-code-pro-latin-600.woff2" => {
                Ok(HttpResponse::woff2(FONTS_SOURCE_CODE_600_2))
            }
            "/fonts/source-code-pro-latin-700.woff" => {
                Ok(HttpResponse::woff(FONTS_SOURCE_CODE_700))
            }
            "/fonts/source-code-pro-latin-700.woff2" => {
                Ok(HttpResponse::woff2(FONTS_SOURCE_CODE_700_2))
            }
            "/fonts/source-code-pro-latin-900.woff" => {
                Ok(HttpResponse::woff(FONTS_SOURCE_CODE_900))
            }
            "/fonts/source-code-pro-latin-900.woff2" => {
                Ok(HttpResponse::woff2(FONTS_SOURCE_CODE_900_2))
            }
            _ => Err(req),
        },
        _ => Err(req),
...
static FONTS_LATIN_100_IT: &[u8] =
    include_bytes!("../../../lagosta/fonts/lato-latin-100italic.woff");
static FONTS_LATIN_100_IT_2: &[u8] =
    include_bytes!("../../../lagosta/fonts/lato-latin-100italic.woff2");
...
static FONTS_LATIN_300_IT: &[u8] =
    include_bytes!("../../../lagosta/fonts/lato-latin-300italic.woff");
static FONTS_LATIN_300_IT_2: &[u8] =
    include_bytes!("../../../lagosta/fonts/lato-latin-300italic.woff2");
...
static FONTS_LATIN_400_IT: &[u8] =
    include_bytes!("../../../lagosta/fonts/lato-latin-400italic.woff");

static FONTS_LATIN_400_IT_2: &[u8] =
    include_bytes!("../../../lagosta/fonts/lato-latin-400italic.woff2");
...
static FONTS_LATIN_700_IT: &[u8] =
    include_bytes!("../../../lagosta/fonts/lato-latin-700italic.woff");
static FONTS_LATIN_700_IT_2: &[u8] =
    include_bytes!("../../../lagosta/fonts/lato-latin-700italic.woff2");
...
static FONTS_LATIN_900_IT: &[u8] =
    include_bytes!("../../../lagosta/fonts/lato-latin-900italic.woff");
static FONTS_LATIN_900_IT_2: &[u8] =
    include_bytes!("../../../lagosta/fonts/lato-latin-900italic.woff2");

static FONTS_SOURCE_CODE_200: &[u8] =
    include_bytes!("../../../lagosta/fonts/source-code-pro-latin-200.woff");
static FONTS_SOURCE_CODE_200_2: &[u8] =
    include_bytes!("../../../lagosta/fonts/source-code-pro-latin-200.woff2");
static FONTS_SOURCE_CODE_300: &[u8] =
    include_bytes!("../../../lagosta/fonts/source-code-pro-latin-300.woff");
static FONTS_SOURCE_CODE_300_2: &[u8] =
    include_bytes!("../../../lagosta/fonts/source-code-pro-latin-300.woff2");
static FONTS_SOURCE_CODE_400: &[u8] =
    include_bytes!("../../../lagosta/fonts/source-code-pro-latin-400.woff");
static FONTS_SOURCE_CODE_400_2: &[u8] =
    include_bytes!("../../../lagosta/fonts/source-code-pro-latin-400.woff2");
static FONTS_SOURCE_CODE_500: &[u8] =
    include_bytes!("../../../lagosta/fonts/source-code-pro-latin-500.woff");
static FONTS_SOURCE_CODE_500_2: &[u8] =
    include_bytes!("../../../lagosta/fonts/source-code-pro-latin-500.woff2");
static FONTS_SOURCE_CODE_600: &[u8] =
    include_bytes!("../../../lagosta/fonts/source-code-pro-latin-600.woff");
static FONTS_SOURCE_CODE_600_2: &[u8] =
    include_bytes!("../../../lagosta/fonts/source-code-pro-latin-600.woff2");
static FONTS_SOURCE_CODE_700: &[u8] =
    include_bytes!("../../../lagosta/fonts/source-code-pro-latin-700.woff");
static FONTS_SOURCE_CODE_700_2: &[u8] =
    include_bytes!("../../../lagosta/fonts/source-code-pro-latin-700.woff2");
static FONTS_SOURCE_CODE_900: &[u8] =
    include_bytes!("../../../lagosta/fonts/source-code-pro-latin-900.woff");
static FONTS_SOURCE_CODE_900_2: &[u8] =
    include_bytes!("../../../lagosta/fonts/source-code-pro-latin-900.woff2");
