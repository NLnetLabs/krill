...
pub async fn statics(req: Request) -> RoutingResult {
    let res = match *req.method() {
        Method::GET => match req.path.full() {
            ...
            "/assets/index-23bb870c.js" => Ok(HttpResponse::js(JS_INDEX)),
            ...
            "/assets/index-36a2852b.css" => Ok(HttpResponse::css(CSS)),
...
static JS_INDEX: &[u8] = include_bytes!("../../../ui/assets/index-23bb870c.js");
...
static CSS: &[u8] = include_bytes!("../../../ui/assets/index-36a2852b.css");
