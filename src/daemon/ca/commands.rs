...
impl CmdDet {
    ...
    pub fn child_certify(
        ...
        eventsourcing::SentCommand::new(handle, None, CmdDet::ChildCertify(child_handle, request, signer), actor)
    }
    ...
    pub fn child_revoke_key(
        ...
        eventsourcing::SentCommand::new(handle, None, CmdDet::ChildRevokeKey(child_handle, request, signer), actor)
    }

    pub fn child_remove(handle: &Handle, child_handle: ChildHandle, signer: Arc<KrillSigner>, actor: &Actor) -> Cmd {
        eventsourcing::SentCommand::new(handle, None, CmdDet::ChildRemove(child_handle, signer), actor)
    }
    ...
    pub fn upd_received_cert(
        ...
        eventsourcing::SentCommand::new(handle, None, CmdDet::UpdateRcvdCert(class_name, cert, signer), actor)
    }
    ...
    pub fn publish(handle: &Handle, signer: Arc<KrillSigner>, actor: &Actor) -> Cmd {
        eventsourcing::SentCommand::new(handle, None, CmdDet::Republish(signer), actor)
    }
    ...
    pub fn route_authorizations_update(
        ...
        eventsourcing::SentCommand::new(handle, None, CmdDet::RouteAuthorizationsUpdate(updates, signer), actor)
    }
