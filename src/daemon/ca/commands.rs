...
use crate::{
    ...
    daemon::{
        ca::{CaEvt, ResourceTaggedAttestation, RoaPayloadKeyUpdates, RtaContentRequest, RtaPrepareRequest},
        config::Config,
    },
};
...
pub enum CmdDet {
    ...
    RouteAuthorizationsUpdate(RoaPayloadKeyUpdates, Arc<Config>, Arc<KrillSigner>),
