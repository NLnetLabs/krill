...
use krill_commons::api::ca::{
    ...
    PublicationDelta, RcvdCert, ReplacedObject, RepoInfo, ResourceClassInfo, ResourceClassKeysInfo,
    ResourceClassName, ResourceSet, Revocation, RevokedObject, UpdatedObject, WithdrawnObject,
};
